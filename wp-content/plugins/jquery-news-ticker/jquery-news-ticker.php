...
<?php
      ...
      wp_enqueue_script('1', Jntp_pluginurl.'/scripts/jquery.bootstrap.newsbox.js');
	  wp_enqueue_script('2', Jntp_pluginurl.'/scripts/jquery.bootstrap.newsbox.min.js');
	  wp_enqueue_style( '3', Jntp_pluginurl.'/css/site.css');


          wp_enqueue_style('newsstyle1');
	  wp_enqueue_style('newsstyle2');
...
<ul class="demo2">
	...
	$Jntp_link = $data->Jntp_description;
    ?>
    <li class="news-item"> <?php echo $Jntp_text ;?> </br>  <?php echo $Jntp_link; ?><a href="#">Read more...</a></li>
   <?php
    }
    ?>
...
<!--<div class="sidebarwrap">
 <div class="sidebarheading">
     <h4 class="mainheading"> News Feed</h4>
 </div>
 ...
 foreach ( $data as $data ) 
		{
			...
			$Jntp_link = $data->Jntp_description;
?>
	<dt class="heading"></dt> <dd class="text"> <?php echo $Jntp_text ?></br><?php echo $Jntp_link ?></dd>
<?php
}
?>
    </dl>
...
function Jntp_add_javascript_files() 
{
	if (!is_admin())
	{
	    ...
	    wp_register_script( 'jquery1', 'http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js');
		//wp_register_style( 'newsstyle1', 'http://netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css');
              wp_register_style( 'newsstyle1',  Jntp_pluginurl.'/css/bootstrap.min.css');
        wp_register_style( 'newsstyle2', 'http://netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap-theme.min.css');
